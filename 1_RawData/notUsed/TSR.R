...
# UK Manual UK <- Quandl('UN/UIS_TOTALSECONDARYPUPILTEACHERRATIO__GBR', authcode='GgnxpyUBXHsyQxqp67bY')[1,2]
...
# Ausee manual South Africa manual http://www.iol.co.za/capetimes/cape-pupil-teacher-ratios-on-par-1.1359824
...
# Canada Manual http://www.cmec.ca/Publications/Lists/Publications/Attachments/300/EAG_2013_Canada_EN.pdf Canada <-
# Quandl('UN/UIS_TOTALSECONDARYPUPILTEACHERRATIO__CAN', authcode='GgnxpyUBXHsyQxqp67bY')[1,2] Israel manual
# https://www.oecd.org/edu/EAG2014-Indicator%20D2%20%28eng%29.pdf Israel <-
# Quandl('UN/UIS_TOTALSECONDARYPUPILTEACHERRATIO__ISR', authcode='GgnxpyUBXHsyQxqp67bY')[1,2]
NewZeland <- Quandl("UN/UIS_TOTALSECONDARYPUPILTEACHERRATIO__NZL", authcode = "GgnxpyUBXHsyQxqp67bY")[1, 2]
# Jordan manual http://jordantimes.com/student-teacher-ratio-in-public-schools-within-intl-standards Jordan <-
# Quandl('UN/UIS_TOTALSECONDARYPUPILTEACHERRATIO__JOR', authcode='GgnxpyUBXHsyQxqp67bY')[1,2]
