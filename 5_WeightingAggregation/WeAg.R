...
factor1UnitNormalisation / sum(factorAn$loadings[,1]^2)
factor2UnitNormalisation / sum(factorAn$loadings[,2]^2)
weights.DB7 <- data.frame(factor1UnitNormalisation, factor2UnitNormalisation)
