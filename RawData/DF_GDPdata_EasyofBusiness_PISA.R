...
pisa <- read.csv("/srv/shiny-server/RealBachelor/RawData/Copy of PISA summary - 2012.csv", header=FALSE)
...
joinedDF <- dplyr::full_join(TigersGD2, pisa, by= "Country")
...
joinedDB.3 <- dplyr::full_join(easydb, joinedDF, by= "Country")
...
corrplot(corelationMat.joined, method = "number",  order = "hclust", addrect = 2)
