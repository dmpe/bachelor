...
# what kind of data type is X2015 http://www.statmethods.net/input/datatypes.html
# class(GDPperCapitaIMF$X2015)

# delete comma , from X2015 column strings and replace it with nothing
